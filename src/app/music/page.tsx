    ...
    <div className="min-h-screen" style={{ backgroundColor: '#d03829' }}>
        ...
        <div className="mt-24">
          ...
          <div className="max-w-3xl mx-auto px-6">
            <div className="opacity-0 animate-fade-in-up" style={{ animationDelay: '2400ms', animationFillMode: 'forwards' }}>
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-4 sm:p-6 lg:p-8 border-2" style={{
                borderColor: '#f8d550',
                ...
                <div className="space-y-4 sm:space-y-6">
                  {/* Item 1 */}
                  <div className="py-3 border-b" style={{ borderBottomColor: '#f8d550' + '20' }}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">House Margarita</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$12</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Tequila, lime juice, triple sec</p>
                  </div>

                  {/* Item 2 */}
                  <div className="py-3 border-b" style={{ borderBottomColor: '#f8d550' + '20' }}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">Moscow Mule</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$11</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Vodka, ginger beer, lime juice</p>
                  </div>

                  {/* Item 3 */}
                  <div className="py-3 border-b" style={{ borderBottomColor: '#f8d550' + '20' }}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">Whiskey Sour</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$13</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Bourbon, lemon juice, simple syrup</p>
                  </div>

                  {/* Item 4 */}
                  <div className="py-3 border-b" style={{ borderBottomColor: '#f8d550' + '20' }}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">Craft Beer Selection</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$10</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Local and imported craft beers</p>
                  </div>

                  {/* Item 5 */}
                  <div className="py-3 border-b" style={{ borderBottomColor: '#f8d550' + '20' }}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">House Wine</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$12</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Red, white, and rosé selections</p>
                  </div>

                  {/* Item 6 */}
                  <div className="py-3 border-b" style={{ borderBottomColor: '#f8d550' + '20' }}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">Artisan Cheese Board</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$18</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Selection of premium cheeses and accompaniments</p>
                  </div>

                  {/* Item 7 */}
                  <div className="py-3 border-b" style={{ borderBottomColor: '#f8d550' + '20' }}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">Truffle Fries</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$12</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Hand-cut fries with truffle oil and parmesan</p>
                  </div>

                  {/* Item 8 */}
                  <div className="py-3 border-b" style={{ borderBottomColor: '#f8d550' + '20' }}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">Premium Coffee</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$5</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Espresso, cappuccino, and specialty drinks</p>
                  </div>

                  {/* Item 9 */}
                  <div className="py-3 border-b" style={{ borderBottomColor: '#f8d550' + '20' }}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">Fresh Juice Selection</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$6</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Orange, apple, cranberry, and seasonal options</p>
                  </div>

                  {/* Item 10 */}
                  <div className="py-3">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-base sm:text-lg font-light text-white tracking-wide pr-4">Chocolate Lava Cake</h3>
                      <span className="text-base sm:text-lg font-medium flex-shrink-0" style={{ color: '#f8d550' }}>$10</span>
                    </div>
                    <p className="text-white/60 text-sm font-light leading-relaxed">Warm chocolate cake with vanilla ice cream</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="mt-32" style={{ 
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start mb-6">
                ...
                />
                <div>
                  <h3 className="text-2xl font-light text-white tracking-wide">Seven Monkeys</h3>
                  <p className="text-sm font-light tracking-wider uppercase" style={{ color: '#f8d550' }}>THE BAR</p>
                </div>
              </div>
              <p className="text-white/70 text-sm font-light leading-relaxed max-w-sm mx-auto md:mx-0">
                Where Music Meets Magic. Experience curated musical journeys in an atmosphere of sophistication and style.
              </p>
            </div>

            {/* Quick Links */}
            <div className="text-center md:text-left">
              <h4 className="text-lg font-light text-white mb-6 tracking-wide">Quick Links</h4>
              <div className="space-y-3">
                <a href="#music" className="block text-white/60 hover:text-white transition-colors duration-300 text-sm font-light tracking-wide">
                  DJ Platform
                </a>
                <a href="#menu" className="block text-white/60 hover:text-white transition-colors duration-300 text-sm font-light tracking-wide">
                  Craft Cocktails
                </a>
                <a href="#events" className="block text-white/60 hover:text-white transition-colors duration-300 text-sm font-light tracking-wide">
                  Events
                </a>
                <a href="#contact" className="block text-white/60 hover:text-white transition-colors duration-300 text-sm font-light tracking-wide">
                  Contact Us
                </a>
              </div>
            </div>
            ...
            {/* Contact Info */}
            <div className="text-center md:text-left">
              <h4 className="text-lg font-light text-white mb-6 tracking-wide">Visit Us</h4>
              <div className="space-y-3">
                ...
                <p className="text-white/60 text-sm font-light tracking-wide">
                  Phone: (555) 123-MUSIC<br />
                  Email: info@sevenmonkeys.bar
                </p>
                <div className="flex justify-center md:justify-start gap-4 mt-6">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110" style={{
                    background: 'rgba(248, 213, 80, 0.1)',
                    border: '1px solid rgba(248, 213, 80, 0.3)'
                  }}>
                    <svg className="w-4 h-4" style={{ color: '#f8d550' }} fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Bottom Section */}
          <div className="border-t pt-8" style={{ borderTopColor: '#f8d550' + '20' }}>
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-white/50 text-xs font-light tracking-wide">
                © 2024 Seven Monkeys The Bar. All rights reserved.
              </p>
              <div className="flex gap-6">
                <a href="#privacy" className="text-white/50 hover:text-white transition-colors duration-300 text-xs font-light tracking-wider uppercase">
                  Privacy Policy
                </a>
                <a href="#terms" className="text-white/50 hover:text-white transition-colors duration-300 text-xs font-light tracking-wider uppercase">
                  Terms of Service
                </a>
                <a href="#contact" className="text-white/50 hover:text-white transition-colors duration-300 text-xs font-light tracking-wider uppercase">
                Contact
                </a>
              </div>
            </div>
